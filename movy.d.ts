import { BufferGeometry, CameraHelper, Mesh, Object3D, PerspectiveCamera, Vector3 } from 'three';
...
declare class SceneObject {
    ...
    addArrow(p1: [number, number, number?], p2: [number, number, number?], params?: AddArrowParameters): LineObject;
    addArrow3D(p1: [number, number, number?], p2: [number, number, number?], params?: AddArrowParameters): SceneObject;
    ...
    changeColor(color: string | number, params?: AnimationParameters): this;
    ...
    grow2({ duration, t }?: AnimationParameters): this;
    ...
    vertexToAnimate: Map<number, Vector3>;
...
declare class TextObject extends GroupObject {
    ...
    typeText({ t, duration, interval, cursorBlinkSpeed, cursorBlinkCount, }?: TypeTextParameters): this;
    transformText(to: string, params?: TransformTexParameters): this;
    /**
     * @deprecated Use `setText()` instead.
     */
    updateText(text: string, params?: AnimationParameters): this;
    setText(text: string, params?: AnimationParameters): void;
}
declare class LineObject extends SceneObject {
    ...
    drawLine(params?: AnimationParameters): this;
}
...
interface Transform {
    ...
    scale?: number;
    parent?: SceneObject;
    anchor?: 'left' | 'right' | 'top' | 'bottom' | 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight' | [number, number, number?];
...
export declare function setFPS(fps: number): void;
...
export declare function addCone(params?: AddConeParameters): SceneObject;
...
export declare function addImage(file: string, params?: AddObjectParameters): SceneObject;
export declare function addVideo(file: string, params?: AddObjectParameters): SceneObject;
export declare function addLine(points: [number, number, number?][], params: AddLineParameters): LineObject;
/**
 * @deprecated
 */
export declare function addLine(p1: [number, number, number?], p2: [number, number, number?], params: AddLineParameters): LineObject;
export declare function addPoint(params?: AddObjectParameters): GeometryObject;
...
export declare function addArrow(p1: [number, number, number?], p2: [number, number, number?], params?: AddArrowParameters): LineObject;
export declare function addArrow3D(p1: [number, number, number?], p2: [number, number, number?], params?: AddArrowParameters): SceneObject;
...
declare class Axes3DObject extends SceneObject {
    axisX: SceneObject;
    axisY: SceneObject;
    axisZ: SceneObject;
    animateCreation(params?: AnimationParameters): void;
}
export declare function addAxes3D(params?: AddAxes3DParameters): Axes3DObject;
